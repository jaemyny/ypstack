...
echo "======================================"
echo " stats-finance-mcp 설치 시작"
echo "======================================"
echo ""
echo " 금리·경제지표·기업공시·재무제표"
echo ""
...
echo ""
echo "  ┌─ OpenDART (금융감독원) ─────────────────────────────"
echo "  │  발급: https://opendart.fss.or.kr"
read -p "  │  DART API 키: " DART_KEY
...
if [ -f "$MCP_JSON" ]; then
    if grep -q '"stats-finance"' "$MCP_JSON" 2>/dev/null; then
        echo "      이미 stats-finance 설정이 존재합니다."
